...
function MyRecipeDetailModal({ show, onHide, recipe }) {
  ...
  // User can edit if they're the creator or an admin
  const canEdit = true; // All recipes in MyRecipe are user's own recipes
  
  // Debug recipe data when it changes
  useEffect(() => {
    if (recipe && show) {
...
export default MyRecipeDetailModal;